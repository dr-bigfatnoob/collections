package us.bigfatnoob.utils;

import java.util.Comparator;

/**
 * Created by @bigfatnoob on 4/2/17.
 * Class containing compare methods.
 */
public class Compare {
     ...
     */
    public static boolean less(Object one, Object two, Comparator c) {
        if (c != null)
     ...
     * @return True if c.compare(one, two) > 0 else False
     */
    public static boolean more(Object one, Object two, Comparator c) {
        if (c != null)
            return c.compare(one, two) > 0;
        else if (one instanceof Comparable && two instanceof Comparable)
            return ((Comparable) one).compareTo(two) > 0;
     ...
     * @return True if c.compare(one, two) < 0 else False
     */
    public static int compare(Object one, Object two, Comparator c) {
        if (c != null)
     ...
     */
    public static boolean compare(Comparable one, Comparable two, Order order) {
    ...
    public static boolean compare(Object one, Object two, Order order, Comparator c) {
        if (order.equals(Order.ASCENDING))
